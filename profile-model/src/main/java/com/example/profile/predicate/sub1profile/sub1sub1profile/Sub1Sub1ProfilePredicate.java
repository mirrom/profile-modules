...
public class Sub1Sub1ProfilePredicate {
    
    private SearchCriteria searchCriteria;
    
    public Sub1Sub1ProfilePredicate(final SearchCriteria searchCriteria) {
    ...
    public BooleanExpression getPredicate() {
        ...
        PathBuilder<Sub1Sub1Profile> entityPath = new PathBuilder<>(Sub1Sub1Profile.class, "sub1Sub1Profile");
